...
Artist.create(name: "Skyler Skjelset", position: "Bass", active_member: false, group: Group.first)
...
# Albums
puts "Seeding Albums..."
Album.create(name: "Beach House", release_date: "", group: Group.first))
Album.create(name: "Devotion", release_date: "", group: Group.first))
Album.create(name: "Teen Dream", release_date: "", group: Group.first))
Album.create(name: "Bloom", release_date: "", group: Group.first))
Album.create(name: "Depression Cherry", release_date: "", group: Group.first))
Album.create(name: "Thank Your Lucky Stars", release_date: "", group: Group.first))
Album.create(name: "B Sides and Rarities", release_date: "", group: Group.first))
Album.create(name: "7", release_date: "", group: Group.first))

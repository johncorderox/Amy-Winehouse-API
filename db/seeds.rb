...
Album.create!([
  {name: "Beach House", release_date: "October 3, 2006", date: nil, group_id: 1},
  {name: "Devotion", release_date: "Feburary 26, 2008", date: nil, group_id: 1},
  {name: "Teen Dream", release_date: "Janurary 26, 2010", date: nil, group_id: 1},
  {name: "Bloom", release_date: "May 15, 2012", date: nil, group_id: 1},
  {name: "Depression Cherry", release_date: "August 28, 2015", date: nil, group_id: 1},
  {name: "Thank Your Lucky Stars", release_date: "October 16, 2015", date: nil, group_id: 1},
  {name: "B Sides and Rarities", release_date: "June 30, 2017", date: nil, group_id: 1},
  {name: "7", release_date: "May 11, 2018", date: nil, group_id: 1}
])
Artist.create!([
...
# # Songs
# puts "Seeding Songs...."
# Song.create(name: "Saltwater", length: 2.55, album: Album.find_by(name: "Beach House", group: Group.first))
# Song.create(name: "Tokyo Witch", length: 3.42, album: Album.find_by(name: "Beach House", group: Group.first))
# Song.create(name: "Apple Orchard", length: 4.31, album: Album.find_by(name: "Beach House", group: Group.first))
# Song.create(name: "Master of None",length: 3.19, album: Album.find_by(name: "Beach House", group: Group.first))
# Song.create(name: "Auburn and Ivory", length: 4.30, album: Album.find_by(name: "Beach House", group: Group.first))
# Song.create(name: "Childhood", length: 3.35, album: Album.find_by(name: "Beach House", group: Group.first))
# Song.create(name: "Lovelier Girl", length: 3.02, album: Album.find_by(name: "Beach House", group: Group.first))
# Song.create(name: "House on the Hill", length: 3.14, album: Album.find_by(name: "Beach House", group: Group.first))
# Song.create(name: "Heart and Lungs", length: 7.50, album: Album.find_by(name: "Beach House", group: Group.first))
#
# Song.create(name: "Wedding Bell", length: 3.54, album: Album.find_by(name: "Devotion", group: Group.first))
# Song.create(name: "You Came To Me", length: 4.05, album: Album.find_by(name: "Devotion", group: Group.first))
# Song.create(name: "Gila", length: 4.46, album: Album.find_by(name: "Devotion", group: Group.first))
# Song.create(name: "Turtle Island", length: 3.59, album: Album.find_by(name: "Devotion", group: Group.first))
# Song.create(name: "Holy Dances", length: 4.19, album: Album.find_by(name: "Devotion", group: Group.first))
# Song.create(name: "All The Years", length: 3.36, album: Album.find_by(name: "Devotion", group: Group.first))
# Song.create(name: "Heart of Chambers", length: 4.25, album: Album.find_by(name: "Devotion", group: Group.first))
# Song.create(name: "Some Things Last A Long Time", length: 2.31, album: Album.find_by(name: "Devotion", group: Group.first))
...
#
# #Labels
# Label.create(name: "Carpark", location: "Washington, D.C.", group: Group.first))
# Label.create(name: "Bella Union", location: "Longon, England", group: Group.first))
# Label.create(name: "Sub Pop", location: "Seattle, Washington", group: Group.first))
# Label.create(name: "Misletone", location: "Australia", group: Group.first))
# Label.create(name: "Arts & Crafts Mexico", location: "Mexico", group: Group.first))
#
# #Quotes
